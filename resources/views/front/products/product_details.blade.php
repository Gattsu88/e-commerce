...
<div class="span9">
    ...
    <div class="row">
        <div id="gallery" class="span3">
            <a href="{{ asset('images/product_images/large/'.$productDetails['main_image']) }}" title="{{ $productDetails['main_image'] }}">
                <img src="{{ asset('images/product_images/medium/'.$productDetails['main_image']) }}" style="width:100%;" alt="{{ $productDetails['main_image'] }}"/>
            </a>
            <div id="differentview" class="moreOptopm carousel slide">
                <div class="carousel-inner">
                    <div class="item active">
                        @foreach($productDetails['images'] as $image)
                        <a href="{{ asset('images/product_images/large/'.$image['image']) }}"> <img style="width:29%" src="{{ asset('images/product_images/medium/'.$image['image']) }}" alt=""/></a>
                        @endforeach
                    </div>
                </div>
                <!--
        ...
        <div class="span6">
            ...
            <hr class="soft"/>
            <small><span class="getAttrStock">{{ $totalStock }} items in stock.</span></small>
            <form action="{{ url('add-to-cart') }}" method="post" class="form-horizontal qtyFrm">
                ...
                <div class="control-group">
                    <h4 class="getAttrPrice">{{ $productDetails['product_price'] }} rsd</h4>
                        ...
                        <input type="number" name="quantity" id="quantity" class="span1" placeholder="Qty." required>
                ...
                <div class="tab-pane fade" id="profile">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane" id="listView">
                            ...
                            <div class="row">
                                <div class="span2">
                                    @if(isset($relatedProduct['main_image']))
                                        <?php $product_image_path = 'images/product_images/small/'.$relatedProduct['main_image']; ?>
                                    @else
                                        <?php $product_image_path = ''; ?>
                                    @endif
                                    @if(!empty($relatedProduct['main_image']) && file_exists($product_image_path))
                                        <img src="{{ asset('images/product_images/small/'.$relatedProduct['main_image']) }}" alt="">
                                    @else
                                ...
                                <div class="span3 alignR">
                                    <form class="form-horizontal qtyFrm">
                                        <h3>{{ $relatedProduct['product_price'] }} rsd</h3>
                                ...
                                <li class="span3">
                                    <div class="thumbnail">
                                        ...
                                        <div class="caption">
                                            ...
                                            <p>{{ $relatedProduct['product_code'] }}</p>
                                            <h4 style="text-align:center"><a class="btn" href="#"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">{{ $relatedProduct['product_price'] }} rsd</a></h4>
                                        </div>
                                    </div>
                                </li>
                                @endforeach
